...
public class KfcHandler {
    ...
    @Autowired
    public KfcHandler(final ServicesRequestHandler servicesRequestHandler,
        ...
        public Object handleRequest(final Element requestBody, final Request request, final Response response){
            ...
            } else if (requestModule.equals("game")) {
                return this.gameRequestHandler.handleRequest(requestBody, request, response);
            } else {
