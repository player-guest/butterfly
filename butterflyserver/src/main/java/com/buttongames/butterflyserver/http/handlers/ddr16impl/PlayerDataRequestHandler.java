...
public class PlayerDataRequestHandler extends BaseRequestHandler {
     ...
     */
    private final Ddr16ProfileDao ddr16ProfileDao;
    ...
    public PlayerDataRequestHandler(final ButterflyUserDao userDao, final CardDao cardDao, final Ddr16ProfileDao ddr16ProfileDao,
                                    final GhostDataDao ghostDataDao, final UserSongRecordDao songRecordDao) {
        this.userDao = userDao;
        this.cardDao = cardDao;
        this.ddr16ProfileDao = ddr16ProfileDao;
    ...
    private Object handleNewUserRequest(final String refId, final Request request, final Response response) {
        ...
        this.ddr16ProfileDao.create(profile);
     ...
     */
    private String buildCommonCsv(final ddr16UserProfile profile) {
        ...
        if (profile.getTotalPlays() == -1) {
            ...
            this.ddr16ProfileDao.update(profile);
        }
     ...
     * @return The CSV string.
     */
    private String buildOptionCsv(final ddr16UserProfile profile) {
     ...
     * @return The CSV string.
     */
    private String buildLastCsv(final ddr16UserProfile profile) {
     ...
     * @return The CSV string.
     */
    private String buildRivalCsv(final ddr16UserProfile profile) {
     ...
     */
    private void updateProfileFromCSVs(final ddr16UserProfile profile, final String[] common, final String[] option,
        ...
        if (rival != null &&
            ...
            if (rival1Active) {
                rival1 = ddr16ProfileDao.findByDancerCode(Integer.parseInt(rival[GAME_RIVAL_SLOT_1_DDRCODE_OFFSET], 16));
            }

            if (rival2Active) {
                rival2 = ddr16ProfileDao.findByDancerCode(Integer.parseInt(rival[GAME_RIVAL_SLOT_2_DDRCODE_OFFSET], 16));
            }

            if (rival3Active) {
                rival3 = ddr16ProfileDao.findByDancerCode(Integer.parseInt(rival[GAME_RIVAL_SLOT_3_DDRCODE_OFFSET], 16));
            }
    ...
    private Object handleUserSaveRequest(final Element requestBody, final Request request, final Response response) {
        ...
        final ddr16UserProfile user = this.ddr16ProfileDao.findByDancerCode(dancerCode);
